...
public class NewAppFragment extends Fragment {
    ...
    public class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View v = getActivity().getLayoutInflater().inflate(R.layout.demo_weixin_app_item, null);
            ((ImageView) v.findViewById(R.id.iv_appIcon)).setImageDrawable(appInfo.appIcon);
            ((TextView) v.findViewById(R.id.tv_appName)).setText(appInfo.appName);
            ((TextView) v.findViewById(R.id.tv_appPackage)).setText(appInfo.packageName);
            return v;
        }
    }
    
    public void invokeByFragmentOne(String str) {
